...
- Aim mode. Long-press the bar's handle, then tap anywhere for a mouse click or long-press for a right click. In a browser that opens the context menu on an image, with Copy image in it.
